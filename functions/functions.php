...
function insertPost(){
	if(isset($_POST['sub'])){
		...
		$mimetype= finfo_file($finfo, $_FILES['upload_image']['tmp_name']);
			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6'>
					<div class='row'>
						...
						<div class='col-sm-6'>
							<h3><a style='text-decoration:none; cursor:pointer;color #3897f0;' href='user_profile.php?u_id=$user_id'>$f_name&nbsp$l_name</a></h3>
